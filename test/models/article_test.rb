...
class ArticleTest < ActiveSupport::TestCase
  ...
  test "::with_partner_tag finds articles from partners with a given tag" do
    ...
    assert_equal 5,
                 found.length,
                 "Expected to only find articles from tagged partners"
  end
  ...
  test "::for_site returns articles for site (via neighbourhood)" do
    ...
    partner_1 =
      create(
        :partner,
        address: create(:address, neighbourhood: neighbourhood_1)
      )
    partner_2 =
      create(
        :partner,
        address: create(:address, neighbourhood: neighbourhood_2)
      )

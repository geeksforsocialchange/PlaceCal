...
class Admin::ArticlesTest < ActionDispatch::IntegrationTest
  ...
  test "partner admin : partner is preselected on /new" do
    ...
    assert_select 'select#article_partner_ids option[selected="selected"]',
                  @partner.name
  end
  ...
  test "editor : author is preselected on /new" do
    ...
    assert_select 'select#article_author_id option[selected="selected"]',
                  @editor.admin_name
  end
  ...
  test "neighbourhood admin : author is preselected on /new" do
    ...
    assert_select 'select#article_author_id option[selected="selected"]',
                  @neighbourhood_admin.admin_name
  end
  ...
  test "new article image upload problem feedback" do
    ...
    assert_select "#form-errors li",
                  text:
                    "Article image You are not allowed to upload \"bmp\" files, allowed types: svg, jpg, jpeg, png"

...
class PartnerIntegrationTest < ActionDispatch::IntegrationTest
  ...
  test "Edit does not have delete button for partner admins" do
    ...
    assert_select "a#destroy-partner",
                  false,
                  "This page must not have a Destroy Partner button"
  end
  ...
  test "Partner has owned tag preselected" do
    ...
    tag_options =
      assert_select "div.partner_tags option", count: 1, text: @tag.name
  ...
  test "Partner create form gives feedback on bad image selection" do
    ...
    assert_select "#form-errors li",
                  text:
                    "Image You are not allowed to upload \"bmp\" files, allowed types: jpg, jpeg, gif, png"

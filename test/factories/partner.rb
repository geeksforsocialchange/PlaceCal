...
FactoryBot.define do
  factory :partner do
    sequence(:name) { |n| "Community Group #{n}" }
    ...
    description do
      "Our cool garden centre is a very cool and neat garden centre. Come to our events. Now."
    end
    ...
    factory :ashton_service_area_partner, class: "Partner" do
      service_areas { build_list(:ashton_service_area, 1) }
    end
    ...
    factory :place do
      sequence(:name) { |n| "Community Venue #{n}" }

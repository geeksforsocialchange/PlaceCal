...
class CalendarImporter::CalendarImporterTest < ActiveSupport::TestCase
  test "imports webcal calendars" do
    url =
      "webcal://p24-calendars.icloud.com/published/2/WvhkIr4F3oBQrToPU-lkO6WwDTpzNTpENs-Qtbo48FhhrAfDp3gkIal2XPd5eUVO0LLERrehetRzj43c6zvbotf9_DNI6heKXBejvAkz8JQ"
  ...
  test "imports google calendars" do
    url =
      "https://calendar.google.com/calendar/ical/alliscalm.net_u2ktkhtig0b7u9bd9j8re3af2k%40group.calendar.google.com/public/basic.ics"

    VCR.use_cassette(
      "Placecal Hulme & Moss Side Google Cal",
      allow_playback_repeats: true
    ) do
      calendar =
        create(:calendar, name: "Placecal Hulme & Moss Size", source: url)
      ...
      assert_equal "Session run by Together Dementia Support call Sally on: 0161 2839970",
  ...
  test "imports live.com calendars" do
    url =
      "https://outlook.live.com/owa/calendar/1c816fe0-358f-4712-9b0f-0265edacde57/8306ff62-3b76-4ad5-8dbe-db435bfea444/cid-536CE5C17F8CF3C2/calendar.ics"
  ...
  test "imports manchester u calendars" do
    ...
    VCR.use_cassette("Martin Harris Centre", allow_playback_repeats: true) do
      ...
      assert_equal first_event.summary,
                   "Technical tours of the Martin Harris Centre for Music and Drama"
  ...
  test "imports eventbrite calendars" do
    url =
      "https://www.eventbrite.co.uk/o/berwickshire-association-for-voluntary-service-15751503063"
    ...
    VCR.use_cassette("Eventbrite calendar", allow_playback_repeats: true) do
      ...
      assert_equal "BAVS Forum: Supporting Positive Pathways – Action Research Event",
                   first_event.summary
  ...
  test "does not import if checksum is the same" do
    ...
    VCR.use_cassette("Z-Arts Calendar", allow_playback_repeats: true) do
      calendar =
        create(:calendar, name: "Z-Arts", last_checksum: checksum, source: url)

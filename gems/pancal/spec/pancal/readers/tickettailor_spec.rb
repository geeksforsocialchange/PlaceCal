...
# Ported from PlaceCal spec/jobs/calendar_importer/parsers/tickettailor_spec.rb.

RSpec.describe PanCal::Readers::Tickettailor do
  ...
  describe '.handles_url?' do
    it 'returns truthy for valid TicketTailor box office URLs' do
      source = PanCal::Source.new(url: 'https://www.tickettailor.com/events/queerrunclub')
  ...
  describe '#import_events_from' do
    ...
    it 'converts raw data to TickettailorEvent objects' do
      ...
      expect(events.first).to be_a(PanCal::Events::TickettailorEvent)
    end
    ...
    it 'filters out non-published events' do
      ...
      events = reader.import_events_from([sample_event_data, draft_event])

...
# Ported from PlaceCal spec/jobs/calendar_importer/event_base_html_sanitize_spec.rb
# (CalendarImporter::Events::Base -> PanCal::Event).

RSpec.describe PanCal::Event do

  ...
  def records # rubocop:disable Metrics/MethodLength
    [
      ...
      },
      {
        ...
        slug: "moss-side",
        description:
          "PlaceCal Moss Side is part of the Hulme and Moss Side Age Friendly Partnership, who are working to make Hulme a better place to be for over 50s. \n\nIf you're a local organisation and want to join our network, get in touch below. We provide training and support to help you publish your events.",
        site_admin_id: 1,
        logo: "hulme-header.svg",
        footer_logo: "hulme-footer.svg",
      ...
      },
      {
        ...
        slug: "rusholme",
        description:
          "PlaceCal Rusholme is part of the Hulme and Moss Side Age Friendly Partnership, who are working to make Hulme a better place to be for over 50s. \n\nIf you're a local organisation and want to join our network, get in touch below. We provide training and support to help you publish your events.",
        site_admin_id: 1,
        logo: "hulme-header.svg",
        footer_logo: "hulme-footer.svg",
        ...
        supporters:
          Supporter.where(
            name: ["Trinity House", "Buzz", "People First Wellbeing Service"]
          )
      }
    ]
  end

...
ActiveRecord::Schema.define(version: 20_180_427_122_852) do
  ...
  create_table 'partners_turfs', id: false, force: :cascade do |t|
    ...
    t.index %w[partner_id turf_id], name: 'index_partners_turfs_on_partner_id_and_turf_id'
    t.index %w[turf_id partner_id], name: 'index_partners_turfs_on_turf_id_and_partner_id'
  end
  ...
  create_table 'places_turfs', id: false, force: :cascade do |t|
    ...
    t.bigint 'turf_id', null: false
    t.index %w[place_id turf_id], name: 'index_places_turfs_on_place_id_and_turf_id'
    t.index %w[turf_id place_id], name: 'index_places_turfs_on_turf_id_and_place_id'
  end
  ...
  create_table 'turfs_users', id: false, force: :cascade do |t|
    ...
    t.index %w[turf_id user_id], name: 'index_turfs_users_on_turf_id_and_user_id'
    t.index %w[user_id turf_id], name: 'index_turfs_users_on_user_id_and_turf_id'
  end

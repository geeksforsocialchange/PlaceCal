...
gem 'mini_magick'                 # ImageMagick backend for CarrierWave uploads (soft dep of image_processing 2)
gem 'pagy'                        # Lightweight pagination
gem 'phlex-rails', '~> 2.3'       # Ruby-native view components
gem 'ruby-vips'                   # libvips backend for ActiveStorage variants and OG image rendering (soft dep of image_processing 2)

...
# Core
gem 'json', '< 4'                 # Pin to 2.x: json 3.0 removed JSON.parse's positional options arg, which ActiveSupport::JSON.decode still passes (activesupport 8.1). Unpin once Rails supports json 3.

module Types
  class SiteType < Types::BaseObject
    ...
    field :id, ID, null: false, description: "Internal reference ID"

    field :name, String, null: false, description: "Full name of site"
    ...
    field :description, String, description: "Longer description of site"

module Types
  class NeighbourhoodType < Types::BaseObject
    ...
    field :abbreviated_name,
          String,
          description:
            "Abbreviated version of name or just the name if this is not set"

    field :unit,
          String,
          description:
            "Size of neighbourhood: country -> region -> county -> district -> ward"

    field :unit_name, String, description: "Official name of this neighbourhood"

    field :unit_code_key,
          String,
          description: "Official key for this neighbourhood"

    field :unit_code_value,
          String,

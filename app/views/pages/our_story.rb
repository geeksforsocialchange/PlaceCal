...
class Views::Pages::OurStory < Views::Base
  ...
  def render_problems
    ...
    div(class: 'card card--plain') do
      Details(header: 'People were not working together', summary: 'Every large institution was working on their own community information websites, with different organisations gathering the same data.', image_url: 'home/our_story/not_together.png', image_layout: 'right') do
    ...
    div(class: 'card card--plain') do
      Details(header: "Current software wasn't working", summary: 'Existing community information websites were either maintained on behalf of the groups by institutional staff or required community groups to regularly log in to keep their events updated.', image_url: 'home/our_story/current_software.png', image_layout: 'left') do
    ...
    div(class: 'card card--plain') do
      Details(header: 'Tech skills are very low', summary: 'Digital exclusion has affected community groups disproportionately, particularly in deprived areas such as Manchester. Groups often don\'t have the skills or tools needed to promote themselves effectively.', image_url: 'home/our_story/no_tech_skills.png', image_layout: 'right') do
  ...
  def render_solutions
    ...
    div(class: 'card card--plain') do
      Details(header: 'Collective, not-for-profit ownership', summary: 'To be sustainable, everything must be owned and managed directly by institutions and community groups working together.', image_url: 'home/our_story/collective_ownership.png', image_layout: 'right') do
    ...
    div(class: 'card card--plain') do
      Details(header: 'Software built on existing tools', summary: 'Our software builds on top of tools that community groups are already using, such as Google Calendar, Outlook 365, and Facebook.', image_url: 'home/our_story/use_existing_tools.png', image_layout: 'left') do
    ...
    div(class: 'card card--plain') do
      Details(header: 'A training program that includes everyone', summary: 'Our educational program for institutions and community groups alike walks everyone through the process of publishing and updating their information.', image_url: 'home/our_story/training.png', image_layout: 'right') do

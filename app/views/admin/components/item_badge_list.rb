...
class Views::Admin::Components::ItemBadgeList < Views::Admin::Components::Base
  def initialize(items:, icon_name:, icon_color:, link_path:, empty_text: nil, vertical: false) # rubocop:disable Metrics/ParameterLists
    @items = items
    @icon_name = icon_name

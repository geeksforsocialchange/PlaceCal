...
// Site form tabs controller
// Handles hash navigation for the site edit form
export default class extends Controller {
	...
	restoreTabAfterSave() {
		const savedHash = sessionStorage.getItem("siteTabAfterSave");
		if (savedHash) {
			sessionStorage.removeItem("siteTabAfterSave");
	...
	prepareNextTab() {
		...
		if (nextTab && nextTab.dataset.hash) {
			sessionStorage.setItem("siteTabAfterSave", nextTab.dataset.hash);
		}
	}
}

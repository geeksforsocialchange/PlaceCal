	...
	showLoading() {
      ...
      <tr>
        <td colspan="${this.columnsValue.length}" class="px-6 py-4 text-center text-gray-500">
          <svg style="width: 1.25rem; height: 1.25rem; margin-right: 0.5rem; display: inline-block; animation: spin 1s linear infinite;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">

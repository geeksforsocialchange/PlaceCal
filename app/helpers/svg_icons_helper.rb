...
module SvgIconsHelper
  ...
  ICONS = {
    ...
    bug: 'M12 12v.01M8 8l1.5 1.5M16 8l-1.5 1.5M9 21h6m-6-4v-4a3 3 0 016 0v4m-6 0H5a2 2 0 01-2-2v-2c0-1.1.9-2 2-2h2.17M15 17h4a2 2 0 002-2v-2a2 2 0 00-2-2h-2.17M12 3a3 3 0 00-3 3v1h6V6a3 3 0 00-3-3z',

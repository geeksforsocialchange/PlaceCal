...
module SvgIconsHelper
  ...
  ICONS = {
    ...
    misc_menu: { path: 'M0,0.727 l24,0,0,3.636,-24,0 Z M0,10.182 l24,0,0,3.636,-24,0 Z M0,19.636 l24,0,0,3.636,-24,0 Z', stroke: 'none', fill: 'currentColor' },
    misc_phone: { path: 'M11.928,0 A11.964,11.964,0,0,0,0,11.846,11.746,11.746,0,0,0,3.446,20.302 a11.791,11.791,0,0,0,8.4,3.552 h0.079 A11.962,11.962,0,0,0,23.854,12 C23.909,5.434,18.581,0.053,11.928,0 Z M17.705,15.902 l-0.504,0.504,-0.026,0.026 C16.301,17.306,15.559,17.52,14.4,17.174 a9.744,9.744,0,0,1,-3.288,-1.829 C9.701,14.206,8.191,12.72,7.2,11.184,6.24,9.6,5.911,7.92,7.289,6.547 l0.026,-0.026,0.504,-0.504 a0.989,0.989,0,0,1,1.378,0 l1.565,1.562 a0.998,0.998,0,0,1,0,1.38 L9.84,9.886 l0.026,0.026 A14.011,14.011,0,0,0,13.81,13.862 l0.026,0.026 L14.762,12.96 a0.998,0.998,0,0,1,1.38,0 l1.562,1.565 A0.943,0.943,0,0,1,17.705,15.902 Z', stroke: 'none', fill: 'currentColor' },
